// Example: Using react-icons in your NavBar
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse justify-content-between" id="navbarNav">
          <ul className="navbar-nav mx-auto me-lg-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a className="nav-link text-dark fw-medium hover-underline-red" href="../Component/Footer">Contact</a>
            </li>
            <li className="nav-item">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <a href="">
              <FaHeart style={{ color: "#212529", width: 22, height: 22, cursor: "pointer" }}  /> 
              </a>
            <a href="">
              <FaShoppingCart style={{ color: "#212529", width: 22, height: 22, cursor: "pointer" }} />
            </a>
            <a href="/LoginPage">
            <FaUser style={{ color: "#212529", width: 22, height: 22, cursor: "pointer" }} />
            </a>
            </div>
